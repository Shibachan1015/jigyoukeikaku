...
- 動画を制作して、YouTube動画などにすれば、会場や、お客様の自宅などでも見様見真似で挿げることが出来る。
...
| 区分 | 概算費用 |
|:--|--:|
| **商品製作費（履物・鼻緒・台などの材料・加工費）** | 約700,000円 |
| **出展関連費（ブース料・交通費・宿泊費・駐車場など）** | 約900,000円 |
| **販促・広報費（撮影・印刷物・クラウドファンディング準備・デザイン）** | 約200,000円 |
| **事業推進費（設備改修・研究開発・外注費・試作経費 等）** | 約200,000円 |
| **合計事業費** | **約2,000,000円（200万円）** |
| **うち自己負担（商品代金・一部経費分）** | **約1,000,000円** |
| **支援希望額（奈良中央信用金庫 グッドサポート制度）** | **1,000,000円（事業費の1/2負担）** |

---
### 費用に関する補足文

本事業では、商品開発・材料調達・製造・販促活動などを含めて**総額200万円規模の費用**を見込んでいます。
そのうち、**約100万円を自社商品代金やクラウドファンディング準備費用、その他として自己負担**し、残る1/2にあたる**100万円を「奈良中央信用金庫 グッドサポート制度」からの支援**として申請いたします。

この支援により、
- 新構造の「挿げて育てる履物」の量産準備
- 環境配慮型素材や製造法の導入
- クラウドファンディング実施に向けた試作品・映像製作
を着実に実行し、**地域発の持続可能な和装文化ブランド**を確立してまいります。
...
「わさびや」は、地場産業としての「三郷町の履物文化」と和装履物の伝統をを次世代に継承するとともに、
日本全国の消費者へ向けた新しい和装履物ブランドとして発信し、現代の消費者が共感し、参加できる形へと再構築するプロジェクトを推進し
その成果によって地域経済の活性化に寄与することを目指す。


**“挿げて育てる履物”** という新しい価値観を軸に、
- 修理できるモノづくり
- 長く使えるデザイン
- 自ら関わる楽しさ

を広げ、奈良の地場産業から全国へ文化を発信していきます。

その実現にあたり、**グッドサポート制度の100万円のご支援**を活用し、
職人技術の継承とサステナブルな和装文化の未来づくりを目指します。
